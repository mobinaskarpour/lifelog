...
fun LocationLogEntity.toDomain() = LocationLog(
    id = id,
    latitude = latitude,
    longitude = longitude,
    accuracy = accuracy,
...
fun LocationLog.toEntity() = LocationLogEntity(
    id = id,
    latitude = latitude,
    longitude = longitude,
    accuracy = accuracy,
...
fun BatteryLogEntity.toDomain() = BatteryLog(
    id = id,
    level = level,
...
fun BatteryLog.toEntity() = BatteryLogEntity(
    id = id,
    level = level,
    isCharging = isCharging,
    temperature = temperature,
...
fun ScreenEventEntity.toDomain() = ScreenEvent(
    id = id,
    type = ScreenEventType.valueOf(type),
    timestamp = timestamp,
)

fun ScreenEvent.toEntity() = ScreenEventEntity(
    id = id,
    type = type.name,
    timestamp = timestamp,
)
